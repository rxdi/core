...
export const Bootstrap = (app, config?: ConfigModel): Observable<any> => bootstrapService.start(app, config);
export const BootstrapPromisify = (app, config?: ConfigModel): Promise<any> => bootstrapService.start(app, config).toPromise();
export const BootstrapFramework = (app, modules: any[], config?: ConfigModel): Observable<any> => {
